...
export const metadata: Metadata = { title: "How We Make Money", description: "How BestLaptop.ca earns revenue through affiliate links and ads, and how we keep it separate from reviews.", alternates: { canonical: "/how-we-make-money" } };
