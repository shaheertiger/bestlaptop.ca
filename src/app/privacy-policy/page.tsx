...
export default function Page() {
  return (
    <ContentPage crumb="Privacy Policy" title="Privacy Policy" intro="Last updated June 2026. This summary explains how we handle your information.">
      ...
      <p>We collect basic analytics (such as pages viewed and device type) and any information you provide directly, such as your email when you subscribe to our newsletter or create a membership.</p>
      <h2>How we use it</h2>
      <ul>
        <li>To operate and improve the site and our tools.</li>
        <li>To send our newsletter and deal alerts if you opt in.</li>
        <li>To provide membership features such as saved comparisons and alerts.</li>
      </ul>
