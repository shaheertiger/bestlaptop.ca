...
function buildKeywords(): KeywordTarget[] {
  ...
  const M = {
    ...
    air13m5: R("apple", "macbook-air-13-m5"),
    air15: R("apple", "macbook-air-15-m4"),
    xps14: R("dell", "xps-14-2026"),
    g16: R("asus", "rog-zephyrus-g16-2026"),
    zenbookA14: R("asus", "zenbook-a14-2026"),
    omnibook: R("hp", "omnibook-ultra-14-2026"),
  ...
  const modelReviews: [string, string][] = [
    ...
    ["dell xps 14 review", M.xps14],
    ["dell xps 14 2026 review", M.xps14],
    ["dell xps 14 panther lake review", M.xps14],
    ...
    ["asus rog zephyrus g16 review", M.g16],
    ["asus rog zephyrus g16 2026 review", M.g16],
    ["rog zephyrus g16 rtx 5080 review", M.g16],
    ["asus zenbook a14 review", M.zenbookA14],
    ["asus zenbook a14 snapdragon review", M.zenbookA14],
    ["hp omnibook ultra 14 review", M.omnibook],
    ["hp omnibook ultra review", M.omnibook],
    ["macbook air m5 review", M.air13m5],
    ["macbook air m5 review canada", M.air13m5],
    ["macbook air 13 m5 review", M.air13m5],
    ["macbook air m5 vs m4", M.air13m5],
